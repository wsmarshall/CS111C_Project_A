	...
	public boolean equals (Object otherTrio) {
		...
		if(otherTrio instanceof Trio<?>) {
			...
			if(this.item1.equals(other.item1)) {
				if(this.item2.equals(other.item2) && this.item3.equals(other.item3)){
						trioEquals = true;
					}
				if(this.item2.equals(other.item3) &&this.item3.equals(other.item2)) {
						trioEquals = true;
				}
			}
			if(this.item1.equals(other.item2)) {
				if(this.item2.equals(other.item3) && this.item3.equals(other.item1)) {
						trioEquals = true;
				}
				if(this.item2.equals(other.item1) && this.item3.equals(other.item3)) {
						trioEquals = true;
				}
			}
			if(this.item1.equals(other.item3)) {
				if(this.item2.equals(other.item1) && this.item3.equals(other.item2)) {
						trioEquals = true;
				}
				if(this.item2.equals(other.item2) && this.item3.equals(other.item1)) {
						trioEquals = true;
				}
			}
		}else {
